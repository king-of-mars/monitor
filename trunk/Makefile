...
# Generated by qmake (2.01a) (Qt 4.2.3) on: Wed May 9 20:24:22 2007
...
LINK          = g++
LFLAGS        = 
LIBS          = $(SUBLIBS)  -L/usr/lib -L ./usr/lib -lpcap -lQtGui -lQtCore -lpthread
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
qrc_Ressources.cpp: Ressources.qrc \
		/usr/bin/rcc \
		GFX/systray/heart.svg \
		GFX/systray/bad.svg \
		GFX/systray/trash.svg
