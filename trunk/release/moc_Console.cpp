...
**
** Created: Wed 9. May 16:06:30 2007
...
static const char qt_meta_stringdata_QConsole[] = {
    "QConsole\0"
};

const QMetaObject QConsole::staticMetaObject = {
    { &QTextEdit::staticMetaObject, qt_meta_stringdata_QConsole,
      qt_meta_data_QConsole, 0 }
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QConsole))
